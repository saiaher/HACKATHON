...
h1, h2, h3 { color: #1E1B4B; font-weight: 700; }
...
def show_dashboard():
    ...
    with col1:
        ...
        <div class="metric-card">
            <div style="position:absolute;top:0;left:0;right:0;height:5px;background:#6366F1;"></div>
    ...
    with col4:
        ...
        <div class="metric-card">
            ...
            <div class="metric-value" style="color:#059669;">₹{funds_saved // 10000000}Cr</div>
            <div class="metric-sub" style="color:#64748B;">💰 This Month</div>
        </div>
        """, unsafe_allow_html=True)
